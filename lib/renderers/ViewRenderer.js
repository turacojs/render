    ...
    _createClass(ViewRenderer, [{
        ...
        * @param [data=undefined] */value: function render(view, properties) {
            ...
            return _Promise.resolve(view.render(data)).then(function (content) {
                ...
                return _this._internalRender(view, view.parent, undefined, dataLayout);
            });
        }
    }, {
        key: '_internalRender',
        /** @memberof ViewRenderer 
        * @instance 
        * @method _internalRender 
        * @param sourceView 
        * @param nameOrClass 
        * @param properties 
        * @param data */value: function _internalRender(sourceView, nameOrClass, properties, data) {
