...
function createExpressEngine(dirname) {
    ...
    var componentRenderer = new _ComponentRenderer2['default']((0, _factoriesBasicInstanceFactory2['default'])(dirname + 'components/', 'Component'));

    var viewRenderer = new _ViewRenderer2['default']((0, _factoriesBasicInstanceFactory2['default'])(dirname, 'View'), componentRenderer);
